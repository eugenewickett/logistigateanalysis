...
np.save(os.path.join('casestudyoutputs', '13JUN', 'fam_MS_sourcing_1_util_hi'), util_hi)
np.save(os.path.join('casestudyoutputs', '13JUN', 'fam_MS_sourcing_1_util_lo'), util_lo)
...
# Store
np.save(os.path.join('casestudyoutputs', '13JUN', 'fam_MS_sourcing_1_util_avg_unif_90'), util_avg_unif_90)
np.save(os.path.join('casestudyoutputs', '13JUN', 'fam_MS_sourcing_1_util_avg_rudi_90'), util_avg_rudi_90)
