...
# Store results
np.save(os.path.join('casestudyoutputs', '13JUN', 'fam_MS_underestweight_1_alloc'), alloc)
np.save(os.path.join('casestudyoutputs', '13JUN', 'fam_MS_underestweight_1_util_avg'), util_avg)
np.save(os.path.join('casestudyoutputs', '13JUN', 'fam_MS_underestweight_1_util_hi'), util_hi)
np.save(os.path.join('casestudyoutputs', '13JUN', 'fam_MS_underestweight_1_util_lo'), util_lo)
...
# Store
np.save(os.path.join('casestudyoutputs', '13JUN', 'fam_MS_underestweight_1_util_avg_unif_90'), util_avg_unif_90)
np.save(os.path.join('casestudyoutputs', '13JUN', 'fam_MS_underestweight_1_util_avg_rudi_90'), util_avg_rudi_90)
...
np.save(os.path.join('casestudyoutputs', '13JUN', 'fam_MS_underestweight_1_util_avg_unif_180'), util_avg_unif_180)
np.save(os.path.join('casestudyoutputs', '13JUN', 'fam_MS_underestweight_1_util_avg_rudi_180'), util_avg_rudi_180)
...
alloc, util_avg, util_hi, util_lo = sampf.get_greedy_allocation(csdict_fam, testmax, testint, paramdict,
                                                                printupdate=True, plotupdate=False)
# Store results
np.save(os.path.join('casestudyoutputs', '13JUN', 'fam_MS_underestweight_10_alloc'), alloc)
np.save(os.path.join('casestudyoutputs', '13JUN', 'fam_MS_underestweight_10_util_avg'), util_avg)
np.save(os.path.join('casestudyoutputs', '13JUN', 'fam_MS_underestweight_10_util_hi'), util_hi)
np.save(os.path.join('casestudyoutputs', '13JUN', 'fam_MS_underestweight_10_util_lo'), util_lo)
...
# Store
np.save(os.path.join('casestudyoutputs', '13JUN', 'fam_MS_underestweight_10_util_avg_unif_90'), util_avg_unif_90)
np.save(os.path.join('casestudyoutputs', '13JUN', 'fam_MS_underestweight_10_util_avg_rudi_90'), util_avg_rudi_90)
...
np.save(os.path.join('casestudyoutputs', '13JUN', 'fam_MS_underestweight_10_util_avg_unif_180'), util_avg_unif_180)
np.save(os.path.join('casestudyoutputs', '13JUN', 'fam_MS_underestweight_10_util_avg_rudi_180'), util_avg_rudi_180)
