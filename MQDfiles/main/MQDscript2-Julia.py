...
def cleanMQD():
    ...
    '''
    The given data set list both actual regions and cities in them as the provinces. For the sake of a better geographical
    understanding, cities in regions were considered as directly part of the regions they are in. More precise geographical
    information can be found under facility location. The only exception to this is the city of Addis Ababa, Ethiopia's 
    capital city, since it doesn't officially belong to any region.
    '''
    ...
    MQD_df_ETH.loc[
        ...
        'Province_Name_GROUPED'] = 'Tigray'
    MQD_df_ETH.loc[
        (MQD_df_ETH.Province_Name == 'Amhara')
        | (MQD_df_ETH.Province_Name == 'Metema'),
        'Province_Name_GROUPED'] = 'Amhara'
    MQD_df_ETH.loc[
        (MQD_df_ETH.Province_Name == 'Afar')
        | (MQD_df_ETH.Province_Name == 'Dubti'),
        'Province_Name_GROUPED'] = 'Afar'
    MQD_df_ETH.loc[
        (MQD_df_ETH.Province_Name == 'Assossa'),
        'Province_Name_GROUPED'] = 'Benishangul-Gumuz'
    MQD_df_ETH.loc[
        (MQD_df_ETH.Province_Name == 'Somali')
        | (MQD_df_ETH.Province_Name == 'Jigjiga'),
        'Province_Name_GROUPED'] = 'Somali'
    MQD_df_ETH.loc[
        (MQD_df_ETH.Province_Name == 'Oromia')
        | (MQD_df_ETH.Province_Name == 'Borena'),
        'Province_Name_GROUPED'] = 'Oromia'
    MQD_df_ETH.loc[
        (MQD_df_ETH.Province_Name == 'SNNP')
        | (MQD_df_ETH.Province_Name == 'Arbamnich'),
        'Province_Name_GROUPED'] = 'SNNP'
    ...
    MQD_df_ETH.loc[
        (MQD_df_ETH.Facility_Location == 'Gende Weha') | (MQD_df_ETH.Facility_Name == 'Gende Weha Health Center'),
        'Facility_Location_GROUPED'] = 'Gedio'
    MQD_df_ETH.loc[
        (MQD_df_ETH.Facility_Location == 'Gondar') | (MQD_df_ETH.Facility_Name == 'Gondar University Hospital'),
        'Facility_Location_GROUPED'] = 'Gondar'
    MQD_df_ETH.loc[
    ...
    MQD_df_ETH.loc[
        (MQD_df_ETH.Facility_Name_GROUPED == 'Chinakson Health Center') |
        (MQD_df_ETH.Facility_Name_GROUPED == 'Chinkson Healt Center'),
        'Facility_Name_GROUPED'] = 'Chinakson Health Center'
    MQD_df_ETH.loc[
        (MQD_df_ETH.Facility_Name_GROUPED == 'Gambelahhospital') |
        (MQD_df_ETH.Facility_Name_GROUPED == 'Gambelahospital') |
        (MQD_df_ETH.Facility_Name_GROUPED == 'Hospital') |
        (MQD_df_ETH.Facility_Name_GROUPED == 'Gambella Hospital'),
        'Facility_Name_GROUPED'] = 'Gambela Hospital'
    MQD_df_ETH.loc[
        (MQD_df_ETH.Facility_Name_GROUPED == 'Gandi Hospitl') |
        (MQD_df_ETH.Facility_Name_GROUPED == 'Gandi Hospital'),
        'Facility_Name_GROUPED'] = 'Gandi Hospital'
    MQD_df_ETH.loc[
    ...
    MQD_df_ETH.loc[
        (MQD_df_ETH.Facility_Name_GROUPED == 'Hiwot Grug Store') |
        (MQD_df_ETH.Facility_Name_GROUPED == 'Hiwot Drug Store'),
        'Facility_Name_GROUPED'] = 'Hiwot Drug Store'
    MQD_df_ETH.loc[
        (MQD_df_ETH.Facility_Name_GROUPED == 'Jimma University Spec. Hospital') |
        (MQD_df_ETH.Facility_Name_GROUPED == 'Jimma University Sep. Hospital'),
        'Facility_Name_GROUPED'] = 'Jimma University Specialized Hospital'
    MQD_df_ETH.loc[
    ...
    MQD_df_ETH.loc[
        ...
        (MQD_df_ETH.Facility_Name_GROUPED == 'Metema Hosipital') |
        (MQD_df_ETH.Facility_Name_GROUPED == 'Metema hospital'),
        'Facility_Name_GROUPED'] = 'Metema hospital'
    MQD_df_ETH.loc[
        (MQD_df_ETH.Facility_Name_GROUPED == 'Metu Carl Hospital') |
        (MQD_df_ETH.Facility_Name_GROUPED == 'Metu Karl Hospital'),
        'Facility_Name_GROUPED'] = 'Metu Karl Hospital'
    # While the Moyale Health Center and the Moyale Hospital are 2 different facilities, I believe the Moyale Health 
    # Office is part of one of them. From looking at Maps, it seems it is part of the Moyale Health Center, but that
    # might be wrong.
    MQD_df_ETH.loc[
        (MQD_df_ETH.Facility_Name_GROUPED == 'Moyale health office') |
        (MQD_df_ETH.Facility_Name_GROUPED == 'Moyale health center'),
        'Facility_Name_GROUPED'] = 'Moyale Health Center'
    MQD_df_ETH.loc[
    ...
    # There is no evidence of the existence of the Rabera clinic in Ethiopia. Therefore, I assumed it is a typo and it
    # is in fact the Robera clinic.
    MQD_df_ETH.loc[
        (MQD_df_ETH.Facility_Name_GROUPED == 'Rabera clinic') |
        (MQD_df_ETH.Facility_Name_GROUPED == 'Mega robera clinic'),
        'Facility_Name_GROUPED'] = 'Robera Clinic'
    MQD_df_ETH.loc[
    ...
    '''
    In this section the different branches of the Pfsa network are separated, but in case a unified analysis is necessary
    then the following code can be used:
    
    MQD_df_ETH.loc[
        (MQD_df_ETH.Facility_Name_GROUPED == 'Pfsa') |
        (MQD_df_ETH.Facility_Name_GROUPED == 'Pfsa,Assossa  Branch') |
        (MQD_df_ETH.Facility_Name_GROUPED == 'Pfsa,Assossa,Branch') |
        (MQD_df_ETH.Facility_Name_GROUPED == 'Pfsa,Assosa Branch') |
        (MQD_df_ETH.Facility_Name_GROUPED == 'Pfsa,Nekemt,Branch') |
        (MQD_df_ETH.Facility_Name_GROUPED == 'Pfsa,Nekemet Branch')|
        (MQD_df_ETH.Facility_Name_GROUPED == 'Gambela Branch Pfsa Hub')|
        (MQD_df_ETH.Facility_Name_GROUPED == 'Pfsa/Mekele')|
        (MQD_df_ETH.Facility_Name_GROUPED == 'Pfsa/Shire'),
        'Facility_Name_GROUPED'] = 'Pfsa'
    
    '''
    MQD_df_ETH.loc[
        (MQD_df_ETH.Facility_Name_GROUPED == 'Pfsa,Nekemt,Branch') |
        (MQD_df_ETH.Facility_Name_GROUPED == 'Pfsa,Nekemet Branch'),
        'Facility_Name_GROUPED'] = 'Pfsa - Nekemet'
    MQD_df_ETH.loc[
        (MQD_df_ETH.Facility_Name_GROUPED == 'Pfsa') |
        (MQD_df_ETH.Facility_Name_GROUPED == 'Pfsa,Assossa  Branch') |
        (MQD_df_ETH.Facility_Name_GROUPED == 'Pfsa,Assossa,Branch') |
        (MQD_df_ETH.Facility_Name_GROUPED == 'Pfsa,Assosa Branch'),
        'Facility_Name_GROUPED'] = 'Pfsa - Assossa'
    MQD_df_ETH.loc[
        (MQD_df_ETH.Facility_Name_GROUPED == 'Gambela Branch Pfsa Hub'),
        'Facility_Name_GROUPED'] = 'Pfsa - Gambela'
    MQD_df_ETH.loc[
        (MQD_df_ETH.Facility_Name_GROUPED == 'Pfsa/Mekele'),
        'Facility_Name_GROUPED'] = 'Pfsa - Mekele'
    MQD_df_ETH.loc[
        (MQD_df_ETH.Facility_Name_GROUPED == 'Pfsa/Shire'),
        'Facility_Name_GROUPED'] = 'Pfsa - Shire'
    MQD_df_ETH.loc[
    ...
    MQD_df_ETH.loc[
        (MQD_df_ETH.Facility_Name_GROUPED == 'Wolisso Health Center') |
        (MQD_df_ETH.Facility_Name_GROUPED == 'Wollisso Health Center'),
        'Facility_Name_GROUPED'] = 'Wolisso Health Center'
    ...
    # Manual adjustments
    MQD_df_ETH.loc[
        (MQD_df_ETH.Manufacturer_GROUPED == 'Alkem Laboratories Ltd')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Alkem Laboratories'),
        'Manufacturer_GROUPED'] = 'Alkem Laboratories'
    MQD_df_ETH.loc[
        (MQD_df_ETH.Manufacturer_GROUPED == 'Addis Pharmaceutical Factory')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Addis Pharmaceuticals Factory')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Addis Pharmaciutical Plc')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Addis Pharmaceutical Factoryplc')
    ...
    MQD_df_ETH.loc[
        ...
        |(MQD_df_ETH.Manufacturer_GROUPED == 'Astra Lifecare')
    ...
    MQD_df_ETH.loc[
        ...
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Cadila Health Care Ltd.')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Cadila Pharm.Plc')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Cadila Pharmaceuticals Plc')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Cadila Pharmaceuticals')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Cadila  Pharmaceutical')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Cadila Pharmaceuticalsd')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Cadila Pharmaceuutical')
    ...
    MQD_df_ETH.loc[
        ...
        |(MQD_df_ETH.Manufacturer_GROUPED == 'East Africa Pharmaceuticals')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'East Africa Pharmaceuticals Plc')
    ...
    MQD_df_ETH.loc[
        ...
        | (MQD_df_ETH.Manufacturer_GROUPED == 'EPHARM')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Eparm')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Ephrm'),
    ...
    MQD_df_ETH.loc[
        ...
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Guilin Pharmaceutical Co.Ltd')
    ...
    MQD_df_ETH.loc[
        (MQD_df_ETH.Manufacturer_GROUPED == 'Inresa Arznemittel Gmbh')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Inresa Arzneimittel Gmbh')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Enresa Arznemittemgnbh'),
        'Manufacturer_GROUPED'] = 'Inresa Arzneimittel Gmbh'
    MQD_df_ETH.loc[
        (MQD_df_ETH.Manufacturer_GROUPED == 'Intas Pharmaceuticals')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Intas Pharmaceuticals Ltd'),
        'Manufacturer_GROUPED'] = 'Intas Pharmaceuticals Ltd'
    MQD_df_ETH.loc[
    ...
    MQD_df_ETH.loc[
        (MQD_df_ETH.Manufacturer_GROUPED == 'Kbi Kunststott Betel')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Kbi/Nutriset'),
        'Manufacturer_GROUPED'] = 'Kbi Kunststott Betel'
    MQD_df_ETH.loc[
    ...
    MQD_df_ETH.loc[
        ...
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Leben Labratories')
    ...
    MQD_df_ETH.loc[
        ...
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Laboratories Pharmaceutical Rodael')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Lp Rodael')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Rodael Pharmaceutical Laboratories'),
    ...
    MQD_df_ETH.loc[
        (MQD_df_ETH.Manufacturer_GROUPED == 'Medochemie')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Medochemie Ltd'),
        'Manufacturer_GROUPED'] = 'Medochemie Ltd'
    MQD_df_ETH.loc[
        (MQD_df_ETH.Manufacturer_GROUPED == 'Medicamen Biotech Laboratories')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Medicamen Biotech')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Medicamen Bitch Ltd')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Medicamen Biotechltd')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Medicamen Biotech ltd')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Medcamen Biotech Ltd'),
    ...
    MQD_df_ETH.loc[
        ...
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Novarties')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Novartis Saqlik')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'NOVARTIS SAGLIK')
    ...
    MQD_df_ETH.loc[
        ...
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Unique Pharmaceutical Laboratories')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Unique Pharmaceuticals')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Unik Pharmaceutical Labratories')
    ...
    MQD_df_ETH.loc[
        ...
        |(MQD_df_ETH.Manufacturer_GROUPED == 'Universal Coperation')
        | (MQD_df_ETH.Manufacturer_GROUPED == 'Univ Rsal')
    ...
    # Manual adjustments
    '''
    While the initial look at Ghana's regions suggests that Accra, Greater Accra, Ashanti, and Volta could be inserted
    into the regions established by cardinal directions, upon closer inspection of Ghana's map, it can be seen that
    Ghana's regions are named as a mix of both cardinal directions and actual names, meaning they should all be
    considered as separate things.
    
    Accra is a big city within the Greater Accra region. The next 3 lines of code group them together, but it can be
    commented out in case the specific access to the city's data needs to be accessed.
    '''
    MQD_df_GHA.loc[
    ...
    MQD_df_GHA.loc[
        (MQD_df_GHA.Province_Name_GROUPED == 'Greater Accra')
        | (MQD_df_GHA.Province_Name_GROUPED == 'Accra'),
        'Province_Name_GROUPED'] = 'Greater Accra'

    # Facility_Location
    MQD_df_GHA = assignlabels(MQD_df_GHA, 'Facility_Location', thresh=90)

    '''
    Much of data in facility location is listed as either "Missing" or "Unknown". The entries that aren't listed as 
    that, refer to the city, town or village where the store is located. In certain cases, an entry's facility location 
    is not given, but there is an address in facility name. In that situation, the address given was used to find the
    ...
    MQD_df_GHA.loc[
        ...
        | (MQD_df_GHA.Facility_Name_GROUPED == 'TAMALE TEACHING HOSPITAL')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'TAMALE WEST HOSPITAL'),
        'Facility_Location_GROUPED'] = 'Tamale'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Province_Name_GROUPED == 'Accra')
        | (MQD_df_GHA.Province_Name_GROUPED == 'Greater Accra'),
        'Facility_Location_GROUPED'] = 'Accra'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Elikplim Pharmacy & Natual Herbal shop, Box 101, Aflao (Tel 03625 30232)')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Verdi Pharmacy Ltd, P.O.Box AF 262 , Aflao        (Tel 03625 30453)')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Central Aflao Hospital, P.O.Box 31, Aflao')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Agnes Zigah Licenced Chemical Seller(Godsway chemical store), P. O. Box 138.Aflao'),
        'Facility_Location_GROUPED'] = 'Aflao'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Elikem Chemical S. K. Gbodji Licensed Chemical seller P.O.Box 5, Nyive'),
        'Facility_Location_GROUPED'] = 'Nyvie'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Sabastos Pharmacy Ltd, P.O.box KP 67, Kpandu (233-93650145)')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Kpandu Health Centre, Kpandu')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Margaret Marquart Catholic Hospital, P.O. Box 97, Kpandu')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'St Patrick Hospital P.O.Box 181, Kpandu (020-8174732)')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Jaya Chemical Shop (Janet Asense LCS), P.O.Box 227, Kpandu')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Paradise Pharmacy,P.0. Box 94  Kpandu (Tel 0936-50085)'),
        'Facility_Location_GROUPED'] = 'Kpandu'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'New Life Chemicals (Christine addo LCS), P.O.Box 536, Hohoe')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Hohoe Municipal Hospital GHS P.O.Box 27, Hohoe (093522042)')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Miracle Chemical Shop (Christian Senyo Alabi LCS) P.O.Box 200, Gbi Klejo (Hohoe Dist) (028-7102122)')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Secure Pharmacy P.O.Box 35, Hohoe')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'St Roses Pharmacy, P.O.Box 546, Hohoe')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Cel Chemist Ltd, P.O.Box 543, Hohoe (Tel 093522069/22228')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Amazing Grace Chemical store (Adom Charity LCS) P.O.Box 116, Hohoe (0243538318/0209184917)')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Matvin Pharmacy  P.O.Box 397, Hohoe. Tel:0244185027')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Prince of Peace Chemicals (B0niface Abochi LCS) P.O.Box 538, Hohoe'),
        'Facility_Location_GROUPED'] = 'Hohoe'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Anfoega Catholic Hospital, Anfoega'),
        'Facility_Location_GROUPED'] = 'Anfoega'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Hope and Glory Chemical Shop (Hans Evan Stor LCS) Gbi Atabu- 181 (Tel 0540768086)'),
        'Facility_Location_GROUPED'] = 'Gbi Atabu'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Keta Government Hospital  P. O. Box KW 82, Keta')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Kenneth K.Kporvi Licensed Chemical Seller (Unitrasto Chemical store) box 179, Keta. Hse No. K4 Acolatse Estate (096642367/0244736418)'),
        'Facility_Location_GROUPED'] = 'Keta'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'AGONA HEALTH CENTRE'),
        'Facility_Location_GROUPED'] = 'Agona'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'EFFIANKWANTA REGIONAL HOSPITAL'),
        'Facility_Location_GROUPED'] = 'Effiankwanta'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'CAPE COAST METRO HOSPITAL')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'UNIVERSITY OF CAPE COAST HOSPITAL')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'CENTRAL REGIONAL HOSPITAL'),
        'Facility_Location_GROUPED'] = 'Cape Coast'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Makaful Chemical Shop (Mr. Rinto) Kpeve (0243612133)'),
        'Facility_Location_GROUPED'] = 'Kpeve'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Jamasi Government Hospital'),
        'Facility_Location_GROUPED'] = 'Jamasi'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Wellpharma Health Services, P.O.Box 841, Ho at the premises of G & E Pharmacy, Ho')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Volta Regional Hospital, Ho')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Volta Regional Medical Stores, Ho')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'St Peters Clinic, RTC, Ho')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Victorious Mount Zion Pharmacy Ltd,       P.O.Box 101, Ho')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Gabriel Kwaku Adom Licensed Chemical Seller (Gabchem)            P.O.Box  MA 58, Ho')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Ryte Aid Pharmacy, Ho Market, P.O.box HP 910, Ho')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Ho Municipal Hospital, near Ministries, P.O.Box 49, Ho')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Ernest Chemist Opposite Bankoe RC, Ho')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Miracle Life Clinic Ltd         P.O.Box 626, Ho')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Licaban Pharmacy Ho-Kpodzi Junction P.O.Box HP 21, Ho (Tel 091-94951)'),
        'Facility_Location_GROUPED'] = 'Ho'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'BONGO HOSPITAL'),
        'Facility_Location_GROUPED'] = 'Bongo'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'YENDI HOSPITAL')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Yendi  Municipal Hospital'),
        'Facility_Location_GROUPED'] = 'Yendi'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Sape Agbo Memorial Hospital P.O.Box 117, Denu')
        | (MQD_df_GHA.Facility_Name_GROUPED == "Godson Kutronu Licensed chemical Seller(God's Gift Chemical Shop) P. O. Box 26, Denu"),
        'Facility_Location_GROUPED'] = 'Denu'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Agogo Government Hospital'),
        'Facility_Location_GROUPED'] = 'Agogo'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Ankaase Methodist Hospital'),
        'Facility_Location_GROUPED'] = 'Ankaase'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Juaso Health Centre'),
        'Facility_Location_GROUPED'] = 'Juaso'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'BOLGATANGA REGIONAL HOSPITAL'),
        'Facility_Location_GROUPED'] = 'Bolgatanga'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Manhyia Govt Hospital'),
        'Facility_Location_GROUPED'] = 'Manhyia'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'GUSHEGU HOSPITAL'),
        'Facility_Location_GROUPED'] = 'Gushegu'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Emmanuel Chemical Store, Eunice Adom Licensed Chemical seller          (Hno. B/1 Prisons Road)  P.O.Box 265, India'),
        'Facility_Location_GROUPED'] = 'India'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Nkawie Government Hospital'),
        'Facility_Location_GROUPED'] = 'Nkawie'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Kuntenase Government Hospital'),
        'Facility_Location_GROUPED'] = 'Kuntenase'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'TARKWA GOVERNMENT HOSPITAL'),
        'Facility_Location_GROUPED'] = 'Tarkwa'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Ketu South Government Hospital, P.O.Box 126, Aflao (Tel 0962-30240)'),
        'Facility_Location_GROUPED'] = 'Ketu'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Tsito Health Centre, near Tsito Sec Tech, Tsito, P.O.Box 27, Tsito'),
        'Facility_Location_GROUPED'] = 'Tsito'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'TAKORADI HOSPITAL PUBLIC'),
        'Facility_Location_GROUPED'] = 'Takoradi'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'SALTPOND GOVT HOSPITAL'),
        'Facility_Location_GROUPED'] = 'Saltpond'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Bompata Health Centre'),
        'Facility_Location_GROUPED'] = 'Bompata'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'KWESIMINTSIM HOSPITAL'),
        'Facility_Location_GROUPED'] = 'Kwesimintsim'

    # Facility_Name
    MQD_df_GHA = assignlabels(MQD_df_GHA, 'Facility_Name', thresh=90)
    # Manual adjustments
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'East Cantonment Pharmacy Accra')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'East Cantonment Pharmacy'),
        'Facility_Name_GROUPED'] = 'East Cantonment Pharmacy'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'SAFETYLIFE CHEMICALS')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'SAFETY LIFE CHEMICALS'),
        'Facility_Name_GROUPED'] = 'Safety Life Chemicals'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Volta Regional Hospital, Ho'),
        'Facility_Name_GROUPED'] = 'Volta Regional Hospital'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Bedita Pharmacy, Asylum Down Accra')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Bedita Pharmacy'),
        'Facility_Name_GROUPED'] = 'Bedita Pharmacy'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'J.B.DOGNIA & CO LTD')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'J.B.DOGNIA AND CO. LTD'),
        'Facility_Name_GROUPED'] = 'J.B. Dognia & Co. Ltd.'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Korle-bu Polyclinic')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Parker Pharmacy Korle Bu Accra'),
        'Facility_Name_GROUPED'] = 'Korle-bu Polyclinic'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Ernest Chemist Ltd')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'ERNEST CHEMISTS LIMITED')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Ernest Chemist Opposite Bankoe RC, Ho')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Ernest Chemist'),
        'Facility_Name_GROUPED'] = 'Ernest Chemist Ltd.'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Kekule Pharmacy')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'KEKULE PHARMACY'),
        'Facility_Name_GROUPED'] = 'Kekule Pharmacy'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'YENDI HOSPITAL')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Yendi  Municipal Hospital'),
        'Facility_Name_GROUPED'] = 'Yendi Municipal Hospital'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Elikplim Pharmacy & Natual Herbal shop, Box 101, Aflao (Tel 03625 30232)'),
        'Facility_Name_GROUPED'] = 'Elikpim Pharmacy and Natural Herbal Shop'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Sabastos Pharmacy Ltd, P.O.box KP 67, Kpandu (233-93650145)'),
        'Facility_Name_GROUPED'] = 'Sabastos Pharmacy Ltd.'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Elikem Chemical S. K. Gbodji Licensed Chemical seller P.O.Box 5, Nyive'),
        'Facility_Name_GROUPED'] = 'Elikem Chemical S.K.'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'New Life Chemicals (Christine addo LCS), P.O.Box 536, Hohoe'),
        'Facility_Name_GROUPED'] = 'New Life Chemicals'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Gabriel Kwaku Adom Licensed Chemical Seller (Gabchem)            P.O.Box  MA 58, Ho'),
        'Facility_Name_GROUPED'] = 'Gabchem'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Kpandu Health Centre, Kpandu'),
        'Facility_Name_GROUPED'] = 'Kpandu Health Centre'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Anfoega Catholic Hospital, Anfoega'),
        'Facility_Name_GROUPED'] = 'Anfoega Catholic Hospital'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Hope and Glory Chemical Shop (Hans Evan Stor LCS) Gbi Atabu- 181 (Tel 0540768086)'),
        'Facility_Name_GROUPED'] = 'Hope and Glory Chemical Shop'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Jamestown Pharmacy Accra')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'James Town Pharmacy'),
        'Facility_Name_GROUPED'] = 'Jamestown Pharmacy'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Margaret Marquart Catholic Hospital, P.O. Box 97, Kpandu'),
        'Facility_Name_GROUPED'] = 'Margaret Marquart Catholic Hospital'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Keta Government Hospital  P. O. Box KW 82, Keta'),
        'Facility_Name_GROUPED'] = 'Keta Government Hospital'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Hohoe Municipal Hospital GHS P.O.Box 27, Hohoe (093522042)'),
        'Facility_Name_GROUPED'] = 'Hohoe Municipal Hospital'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Victorious Mount Zion Pharmacy Ltd,       P.O.Box 101, Ho'),
        'Facility_Name_GROUPED'] = 'Victorious Mount Zion Pharmacy Ltd'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Makaful Chemical Shop (Mr. Rinto) Kpeve (0243612133)'),
        'Facility_Name_GROUPED'] = 'Makaful Chemical Shop'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'St Peters Clinic, RTC, Ho'),
        'Facility_Name_GROUPED'] = 'St Peters Clinic'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'St Patrick Hospital P.O.Box 181, Kpandu (020-8174732)'),
        'Facility_Name_GROUPED'] = 'St Patrick Hospital'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Wellpharma Health Services, P.O.Box 841, Ho at the premises of G & E Pharmacy, Ho'),
        'Facility_Name_GROUPED'] = 'Wellpharma Helth Services'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Miracle Chemical Shop (Christian Senyo Alabi LCS) P.O.Box 200, Gbi Klejo (Hohoe Dist) (028-7102122)'),
        'Facility_Name_GROUPED'] = 'Miracle Chemical Shop'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Parker Pharmacy Korle Bu Accra'),
        'Facility_Name_GROUPED'] = 'Parker Pharmacy'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Sape Agbo Memorial Hospital P.O.Box 117, Denu'),
        'Facility_Name_GROUPED'] = 'Sape Agbo Memorial Hospital'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Verdi Pharmacy Ltd, P.O.Box AF 262 , Aflao        (Tel 03625 30453)'),
        'Facility_Name_GROUPED'] = 'Verdi Pharmacy Ltd'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Osons Chemist, Okaishie Accra'),
        'Facility_Name_GROUPED'] = 'Osons Chemist'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Ebenezer Chemist, Accra'),
        'Facility_Name_GROUPED'] = 'Ebenezer Chemist'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'WW & Partners Pharmacy Accra'),
        'Facility_Name_GROUPED'] = 'WW & Partners Pharmacy'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'K Somuah and Sons Okaishie'),
        'Facility_Name_GROUPED'] = 'K Smuah and Sons Okaishie'
    # The next block of code groups together 2 locations of the Baseline Limited pharmaceutical company. This is an
    # attempt to get a more precise result for the company by increasing the sample size. If wanting to look at
    # individual locations, then the code block can be commented out.
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Baseline Limited Tudu')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'Baseline Limited Okaishie'),
        'Facility_Name_GROUPED'] = 'Baseline Limited'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Asylum Down Pharmacy, Asylum Down Accra'),
        'Facility_Name_GROUPED'] = 'Asylum Down Pharmacy'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Health Watch Pharmacy Samora Michel Road Asylum Down, Accra'),
        'Facility_Name_GROUPED'] = 'Health Watch Pharmacy'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Jaya Chemical Shop (Janet Asense LCS), P.O.Box 227, Kpandu'),
        'Facility_Name_GROUPED'] = 'Jaya Chemical Shop'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Secure Pharmacy P.O.Box 35, Hohoe'),
        'Facility_Name_GROUPED'] = 'Secure Pharmacy'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Emmanuel Chemical Store, Eunice Adom Licensed Chemical seller          (Hno. B/1 Prisons Road)  P.O.Box 265, India'),
        'Facility_Name_GROUPED'] = 'Emmanuel Chemical Store'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Kenneth K.Kporvi Licensed Chemical Seller (Unitrasto Chemical store) box 179, Keta. Hse No. K4 Acolatse Estate (096642367/0244736418)'),
        'Facility_Name_GROUPED'] = 'Unitrasto Chemical Store'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Ryte Aid Pharmacy, Ho Market, P.O.box HP 910, Ho'),
        'Facility_Name_GROUPED'] = 'Ryte Aid pharmacy'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Ho Municipal Hospital, near Ministries, P.O.Box 49, Ho'),
        'Facility_Name_GROUPED'] = 'Ho Municipal Hospital'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'St Roses Pharmacy, P.O.Box 546, Hohoe'),
        'Facility_Name_GROUPED'] = 'St Roses Pharmacy'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Cel Chemist Ltd, P.O.Box 543, Hohoe (Tel 093522069/22228'),
        'Facility_Name_GROUPED'] = 'Cel Chemist Ltd.'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Ketu South Government Hospital, P.O.Box 126, Aflao (Tel 0962-30240)'),
        'Facility_Name_GROUPED'] = 'Ketu South Government Hospital'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Central Aflao Hospital, P.O.Box 31, Aflao'),
        'Facility_Name_GROUPED'] = 'Central Aflao Hospital'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Amazing Grace Chemical store (Adom Charity LCS) P.O.Box 116, Hohoe (0243538318/0209184917)'),
        'Facility_Name_GROUPED'] = 'Amazing Grace Chemical'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Matvin Pharmacy  P.O.Box 397, Hohoe. Tel:0244185027'),
        'Facility_Name_GROUPED'] = 'Matvin Pharmacy'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Miracle Life Clinic Ltd         P.O.Box 626, Ho'),
        'Facility_Name_GROUPED'] = 'Miracle Life Clinic Ltd.'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Paradise Pharmacy,P.0. Box 94  Kpandu (Tel 0936-50085)'),
        'Facility_Name_GROUPED'] = 'Paradise Pharmacy'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Prince of Peace Chemicals (B0niface Abochi LCS) P.O.Box 538, Hohoe'),
        'Facility_Name_GROUPED'] = 'Prince of Peace Chemicals'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Tsito Health Centre, near Tsito Sec Tech, Tsito, P.O.Box 27, Tsito'),
        'Facility_Name_GROUPED'] = 'Tsito Health Centre'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Agnes Zigah Licenced Chemical Seller(Godsway chemical store), P. O. Box 138.Aflao'),
        'Facility_Name_GROUPED'] = 'Godsway Chemical Store'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == "Godson Kutronu Licensed chemical Seller(God's Gift Chemical Shop) P. O. Box 26, Denu"),
        'Facility_Name_GROUPED'] = "God's Gift Chemical Shop"
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == "Licaban Pharmacy Ho-Kpodzi Junction P.O.Box HP 21, Ho (Tel 091-94951)"),
        'Facility_Name_GROUPED'] = "Licaban Pharmacy"
    # The next block of code combines the Regional medical stores from the different regions as a single facility.
    # This allows for the general effects of the network to be analyzed.
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Volta Regional Medical Stores, Ho')
        | (MQD_df_GHA.Facility_Name_GROUPED == 'REGIONAL MEDICAL STORES'),
        'Facility_Name_GROUPED'] = 'Regional Medical Stores'
    '''
     In case the individual regions must be analyzed, then the following three blocks of code can be ran instead of the code above:
     
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'REGIONAL MEDICAL STORES' & MQD_df_GHA.Province_Name_GROUPED == 'Western (Ghana)'),
        'Facility_Name_GROUPED'] = 'Regional Medical Stores - Western Region'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'REGIONAL MEDICAL STORES' & MQD_df_GHA.Province_Name_GROUPED == 'Central'),
        'Facility_Name_GROUPED'] = 'Regional Medical Stores - Central Region'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Facility_Name_GROUPED == 'Volta Regional Medical Stores, Ho'),
        'Facility_Name_GROUPED'] = 'Volta Regional Medical Stores'
    ...
    MQD_df_GHA.loc[
        (MQD_df_GHA.Manufacturer_GROUPED == 'Phyto-Riker (Gihoc) Pharmaceuticals, Ltd.')
        | (MQD_df_GHA.Manufacturer_GROUPED == 'Phyto-Riker (Gihoc) Pharmaceuticals Ltd'),
        'Manufacturer_GROUPED'] = 'Phyto-Riker (Gihoc) Pharmaceuticals Ltd'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Manufacturer_GROUPED == 'Ally Pharma Options Pvt. Ltd')
        | (MQD_df_GHA.Manufacturer_GROUPED == 'Ally Pharma Options Pvt Ltd.'),
        'Manufacturer_GROUPED'] = 'Ally Pharma Options Pvt Ltd.'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Manufacturer_GROUPED == 'Ronak Exim Pvt Ltd')
        | (MQD_df_GHA.Manufacturer_GROUPED == 'Ronak Exim PVT. Ltd'),
        'Manufacturer_GROUPED'] = 'Ronak Exim Pvt Ltd'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Manufacturer_GROUPED == 'Ajanta Pharma Ltd.')
        | (MQD_df_GHA.Manufacturer_GROUPED == 'Ajanta Pharma Ltd'),
        'Manufacturer_GROUPED'] = 'Ajanta Pharma Ltd.'
    MQD_df_GHA.loc[
        (MQD_df_GHA.Manufacturer_GROUPED == 'Danadams Pharmaceuticals Industry Limited')
        | (MQD_df_GHA.Manufacturer_GROUPED == 'Danadams Pharmaceutical Industry Limited')
        | (MQD_df_GHA.Manufacturer_GROUPED == 'Danadams Pharmaceutical Industry, Ltd.'),
        'Manufacturer_GROUPED'] = 'Danadams Pharmaceutical Industry, Ltd.'
    # Novartis is a big pharmaceutical manufacturing company. The Ghana data has entries that refer to both Novartis
    # generally and its specific Beijing manufacturing branch. The next lines of code group them together, but can be
    # commented out in case that is not desired.
    MQD_df_GHA.loc[
        (MQD_df_GHA.Manufacturer_GROUPED == 'Novartis Pharmaceuticals Corporation')
        | (MQD_df_GHA.Manufacturer_GROUPED == 'Beijing Novartis Pharmaceuticals Ltd.'),
        'Manufacturer_GROUPED'] = 'Novartis Pharmaceuticals Corporation'
    ...
    # The data being analyzed includes information from 6 different provinces in peru: Ucayali, Madre de Dios, Amazonas,
    # San Martin, Callao, and Loreto. here is no need for any manual adjustments in the province names.

    # Facility_Location
    '''
    'Provinces' in Peru are the next political sub-division, but the data seem to reflect instead the streets
    where the outlets are located.

    A lot of the data has street names with abbreviations. Here's what they stand for: a Jr. is a "Jirón" (a street), 
    a Av. or Avda. is an "Avenida" (an avenue), a Ctra. is a "Carretera" (a highway), Cdra. is a "Cuadra" (a block), 
    Of. is an Oficina number (Office number), and s/n stands for "sin número" (no number),indicating that the house 
    or building is unnumbered. Similarly, if an address includes hyfenated numbers, it means that the building or
    house in questions spans all the addresses even if it only has one main entrance. Finally, the word Calle also
    means street.
    ...
    # Manual Adjustments
    MQD_df_PER.loc[
        (MQD_df_PER.Facility_Location_GROUPED == 'JR. RAIMONDI N')
        | (MQD_df_PER.Facility_Location_GROUPED == 'JR RAIMONDI n')
        | (MQD_df_PER.Facility_Location_GROUPED == 'JR. RAYMONDI n')
        | (MQD_df_PER.Facility_Location_GROUPED == 'JR. RAYMONDI N'),
        'Facility_Location_GROUPED'] = 'Jr. Raimondi N'
    MQD_df_PER.loc[
        (MQD_df_PER.Facility_Location_GROUPED == 'AV. 28 DE JULIO n')
        | (MQD_df_PER.Facility_Location_GROUPED == 'AV. 28 DE JULIO N'),
        'Facility_Location_GROUPED'] = 'Av. 28 de Julio N'
    # These 2 locations might not be the same.
    MQD_df_PER.loc[
        (MQD_df_PER.Facility_Location_GROUPED == 'AGUIRRE N')
        | (MQD_df_PER.Facility_Location_GROUPED == 'CALLE ELIAS AGUIRRE N'),
        'Facility_Location_GROUPED'] = 'Calle Elias Aguirre N'
    MQD_df_PER.loc[
        (MQD_df_PER.Facility_Location_GROUPED == 'AV. FITZCARRALD n')
        | (MQD_df_PER.Facility_Location_GROUPED == 'AV. FITZCARRALD N'),
        'Facility_Location_GROUPED'] = 'Av. Fitzcarrald N'
    MQD_df_PER.loc[
        (MQD_df_PER.Facility_Location_GROUPED == 'AV. SIMON BOLIVAR N')
        | (MQD_df_PER.Facility_Location_GROUPED == 'AV. SIMON BOLIVAR n'),
        'Facility_Location_GROUPED'] = 'Av. Simon Bolivar N'
    MQD_df_PER.loc[
        (MQD_df_PER.Facility_Location_GROUPED == 'AV. LA MARINA N')
        | (MQD_df_PER.Facility_Location_GROUPED == 'AV. LA MARINA # 285'),
        'Facility_Location_GROUPED'] = 'Av. La Marina N'
    MQD_df_PER.loc[
        (MQD_df_PER.Facility_Location_GROUPED == 'AV. ALMIRANTE GRAU N')
        | (MQD_df_PER.Facility_Location_GROUPED == 'AV.ALMIRANTE GRAU N'),
        'Facility_Location_GROUPED'] = 'Av. Almirante Grau N'
    MQD_df_PER.loc[
        (MQD_df_PER.Facility_Location_GROUPED == 'JR. PROSPERO N')
        | (MQD_df_PER.Facility_Location_GROUPED == 'PROSPERO N'),
        'Facility_Location_GROUPED'] = 'Jr. Prospero N'
    MQD_df_PER.loc[
        (MQD_df_PER.Facility_Location_GROUPED == 'JR BOLOGNESI Y PUTUMAYO N')
        | (MQD_df_PER.Facility_Location_GROUPED == 'JR FRANCISCO BOLOGNESI S/N n'),
        'Facility_Location_GROUPED'] = 'Jr. Francisco Bolognesi N'

    # Facility_Name
    '''
    In the Peru data, there are many entries that refer to "boticas". These are local pharmacies, usually named
    after the streets or neighborhoods they are located in. The main difference between a "botica" and a "farmacia"
    or a "drogueria" is administrative: while farmacias and droguerias are owned by licensed pharmacists, boticas
    are owned by business people or administrative companies that don't have the technical background in pharmacy.

    Much of the data also makes reference to EsSalud. That is Peru's public health insurance system. The system also
    runs certain hospitals and health centers. Some of the data makes direct reference to the specific hospital or
    health center. Some of it refers more broadly to the region's EsSalud system instead.

    Essalud is a national health insurance system that also has several clinics across the country. Since much of the
    data that refers to Essalud clinics only refers to the them as "Essalud" or similar, then the clinincs have been 
    grouped by region in the facility name category.

    All of the Callao data has Callao as the facility location. Therefore no more specific conclusions can be reached
    from that.
    ...
    # Manual Adjustments
    MQD_df_PER.loc[
        (MQD_df_PER.Facility_Name_GROUPED == 'BOTICA TORRES DE LIMATAMBO S.A.C.')
        | (MQD_df_PER.Facility_Name_GROUPED == 'BOTICA TORRES DE LIMATAMBO'),
        'Facility_Name_GROUPED'] = 'Botica Torres de Limatambo S.A.C.'
    MQD_df_PER.loc[
        (MQD_df_PER.Facility_Name_GROUPED == 'BOTICAS INKAFARMA S.A')
        | (MQD_df_PER.Facility_Name_GROUPED == 'BOTICA INKAFARMA'),
        'Facility_Name_GROUPED'] = 'Boticas Inkafarma S.A.'
    ## Eckerd Amazonia S.A.C. is a subsidiary of Drog. Eckerd Peru S.A. (now also called InRetail Pharma S.A.). If
    ## the analysis requires them to be grouped together uncomment the third line below.
    MQD_df_PER.loc[
        (MQD_df_PER.Facility_Name_GROUPED == 'Drog. Eckerd Peru S.A.')
        #   | (MQD_df_PER.Facility_Name_GROUPED == 'ECKERD AMAZONIA S.A.C.')
        | (MQD_df_PER.Facility_Name_GROUPED == 'DROG. ECKERD PERU S.A'),
        'Facility_Name_GROUPED'] = 'Drog. Eckerd Peru S.A.'
    MQD_df_PER.loc[
        (MQD_df_PER.Facility_Name_GROUPED == 'Botica Pharma Yola S.A.C.')
        | (MQD_df_PER.Facility_Name_GROUPED == 'BOTICA PHARMA YOLA SAC'),
        'Facility_Name_GROUPED'] = 'Botica Pharma Yola S.A.C.'
    MQD_df_PER.loc[
        (MQD_df_PER.Facility_Name_GROUPED == 'SERV. FARM. HOSPITAL SAN JOSE')
        | (MQD_df_PER.Facility_Name_GROUPED == 'SERVICIO DE FARMACIA HOSPITAL SAN JOSE'),
        'Facility_Name_GROUPED'] = 'Servicio de Famrmacia Hospital San Jose'
    MQD_df_PER.loc[
        (MQD_df_PER.Facility_Name_GROUPED == 'Serv. Farm. Hosp. Sabogal Sologuren')
        | (MQD_df_PER.Facility_Name_GROUPED == 'SERV. FARMA. HOSPITAL SABOGAL SOLOGUREN'),
        'Facility_Name_GROUPED'] = 'Servicio de Famrmacia Hospital Sabogal Sologuren'
    MQD_df_PER.loc[
        (MQD_df_PER.Facility_Name_GROUPED == 'ALMACEN ESP. DE MED. HOSPITAL CARRION')
        | (MQD_df_PER.Facility_Name_GROUPED == 'Alm. Esp. de Med. Hosp. Carrion'),
        'Facility_Name_GROUPED'] = 'Almacen Especializado de Medicina Hospital Carrion'
    MQD_df_PER.loc[
        (MQD_df_PER.Facility_Name_GROUPED == 'Serv. Farm. Hosp. Sabogal Sologuren')
        | (MQD_df_PER.Facility_Name_GROUPED == 'SERV. FARMA. HOSPITAL SABOGAL SOLOGUREN'),
        'Facility_Name_GROUPED'] = 'Servicio de Famrmacia Hospital Sabogal Sologuren'
    MQD_df_PER.loc[
        (MQD_df_PER.Facility_Name_GROUPED == 'ALMACEN ESPECIALIZADO DISA I CALLAO')
        | (MQD_df_PER.Facility_Name_GROUPED == 'Alm. Esp. DISA I Callao'),
        'Facility_Name_GROUPED'] = 'Almacen Especializado DISA I Callao'
    MQD_df_PER.loc[
        (MQD_df_PER.Facility_Name_GROUPED == 'ESSALUD SERVICIO DE FARMACIA CENTRO MEDICO RODRIGUEZ DE MENDOZA')
        | (MQD_df_PER.Facility_Name_GROUPED == 'SERVICIO DE FARMACIA CENTRO MEDICO RODRIGUEZ DE MENDOZA""')
        | (MQD_df_PER.Facility_Name_GROUPED == 'ESSALUD HIGOS URCO'),
        'Facility_Name_GROUPED'] = 'Essalud - Amazonas'
    MQD_df_PER.loc[
        (MQD_df_PER.Facility_Name_GROUPED == 'DIRECCION REGIONAL DE SALUD AMAZONAS RED CHACHAPOYAS')
        | (MQD_df_PER.Facility_Name_GROUPED == 'DIRECCION REGIONAL DE SALUD AMAZONAS - RED CHACHAPOYAS'),
        'Facility_Name_GROUPED'] = 'Direccion Regional de Salud Amazonas - Red Chachapoyas'
    MQD_df_PER.loc[
        (MQD_df_PER.Facility_Name_GROUPED == 'MIFARMA SAC')
        | (MQD_df_PER.Facility_Name_GROUPED == 'MIFARMA S.A.C.'),
        'Facility_Name_GROUPED'] = 'Mifarma S.A.C.'
    MQD_df_PER.loc[
        (MQD_df_PER.Facility_Name_GROUPED == 'DIXIFARMA E.I.R.L')
        | (MQD_df_PER.Facility_Name_GROUPED == 'DIXIFARMA EIRL'),
        'Facility_Name_GROUPED'] = 'Dixifarma E.I.R.L'
    MQD_df_PER.loc[
        (MQD_df_PER.Facility_Name_GROUPED == 'BOTIC A HIPERMERCADO PIRAMIDE'),
        'Facility_Name_GROUPED'] = 'Botica Hipermercado Piramide'
    MQD_df_PER.loc[
        (MQD_df_PER.Facility_Name_GROUPED == 'BOTI CA PORTUGAL 2 E.I.R.LTDA'),
        'Facility_Name_GROUPED'] = 'Botica Portugal 2 E.I.R. L.T.D.A.'
    MQD_df_PER.loc[
        (MQD_df_PER.Facility_Name_GROUPED == 'CAP III IQUITOS ESSALUD - SEGURO SOCIAL DE SALUD')
        | (MQD_df_PER.Facility_Name_GROUPED == 'CAP II NAUTA ESSALUD - SEGURO SOCIAL DE SALUD')
        | (MQD_df_PER.Facility_Name_GROUPED == 'ES SALUD'),
        'Facility_Name_GROUPED'] = 'Essalud - Loreto'
    ...
    MQD_df_PER.loc[
        (MQD_df_PER.Manufacturer_GROUPED == 'Induquimica S.A.')
        | (MQD_df_PER.Manufacturer_GROUPED == 'Lab. Induquimica S.A. For: Eske S.R.L.'),
        'Manufacturer_GROUPED'] = 'Induquimica S.A.'
    MQD_df_PER.loc[
        (MQD_df_PER.Manufacturer_GROUPED == 'Manufactured for: AC Farma S.A.')
        | (MQD_df_PER.Manufacturer_GROUPED == 'Laboratorios AC Farma S.A.'),
        'Manufacturer_GROUPED'] = 'AC Farma S.A.'
    MQD_df_PER.loc[
        (MQD_df_PER.Manufacturer_GROUPED == 'Lab. Naturales y Genericos SAC')
        | (MQD_df_PER.Manufacturer_GROUPED == 'Naturgen')
        | (MQD_df_PER.Manufacturer_GROUPED == 'Laboratorios Naturales Y Genericos S.A.C.'),
        'Manufacturer_GROUPED'] = 'Naturgen S.A.C.'
    MQD_df_PER.loc[
        (MQD_df_PER.Manufacturer_GROUPED == 'Medifarma S.A.')
        | (MQD_df_PER.Manufacturer_GROUPED == 'Laboratorios Medifarma S.A. '),
        'Manufacturer_GROUPED'] = 'Medifarma S.A.'
    MQD_df_PER.loc[
        (MQD_df_PER.Manufacturer_GROUPED == 'Roemmers S.A.')
        | (MQD_df_PER.Manufacturer_GROUPED == 'LABORATORIOS ROEMMERS S.A.'),
        'Manufacturer_GROUPED'] = 'Roemmers S.A.'
    MQD_df_PER.loc[
        (MQD_df_PER.Manufacturer_GROUPED == 'LABORATORIOS D.A.CARRION S.A.C.')
        | (MQD_df_PER.Manufacturer_GROUPED == 'Lab. D.A. Carrion S.A. / Refasa SAC'),
        'Manufacturer_GROUPED'] = 'Laboratorios D.A.Carrion S.A.C.'
    MQD_df_PER.loc[
        (MQD_df_PER.Manufacturer_GROUPED == 'Bristol-Myers Squibb')
        | (MQD_df_PER.Manufacturer_GROUPED == 'BRISTOL MYERS SQUIBB PERU S.A.'),
        'Manufacturer_GROUPED'] = 'Bristol-Myers Squibb'
    MQD_df_PER.loc[
        (MQD_df_PER.Manufacturer_GROUPED == 'Corporacion Medco S.A.')
        | (MQD_df_PER.Manufacturer_GROUPED == 'CORPORACION MEDCO S.A.C.'),
        'Manufacturer_GROUPED'] = 'Corporacion Medco S.A.'
    MQD_df_PER.loc[
        (MQD_df_PER.Manufacturer_GROUPED == 'FARMINDUSTRIA S.A.')
        | (MQD_df_PER.Manufacturer_GROUPED == 'Farnindustria S.A.'),
        'Manufacturer_GROUPED'] = 'Farmindustria S.A.'
    MQD_df_PER.loc[
        (MQD_df_PER.Manufacturer_GROUPED == 'ECKERD AMAZONIA S.A.')
        | (MQD_df_PER.Manufacturer_GROUPED == 'ECKERD AMAZONIA S.A.C.'),
        'Manufacturer_GROUPED'] = 'Eckerd Amazonia S.A.C.'
    MQD_df_PER.loc[
        (MQD_df_PER.Manufacturer_GROUPED == 'Distribuidora Dany SRLTDA')
        | (MQD_df_PER.Manufacturer_GROUPED == 'DISTRIBUIDORA DANY S.R.LTDA.')
        | (MQD_df_PER.Manufacturer_GROUPED == 'DROGUERIA DANY S.A.C.'),
        'Manufacturer_GROUPED'] = 'Distribuidora Dany S.R.LTDA.'
    MQD_df_PER.loc[
        (MQD_df_PER.Manufacturer_GROUPED == 'BOTICA TORRES DE LIMATAMBO S.A.C.')
        | (MQD_df_PER.Manufacturer_GROUPED == 'BOTICA TORRES DE LIMATAMBO'),
        'Manufacturer_GROUPED'] = 'Botica Torres de Limatambo S.A.C.'
