...
def GenerateMCMCBatch(lgdict, batchsize, filedest):
    ...
    return
# GenerateMCMCBatch(lgdict, 5000, 300, os.path.join('orienteering', 'numpy_objects', 'draws_shuf1_1'))
...
RetrieveMCMCBatches(lgdict, 20, os.path.join('orienteering', 'numpy_objects', 'draws_shuf1_'))
