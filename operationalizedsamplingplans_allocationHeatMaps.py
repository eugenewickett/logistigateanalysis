...
col = 'Purples'
vmax=100
MakeAllocationHeatMap(init_n_700_BASE, optparamdict, plotTitle='B=700, base setting', cmapstr=col,
                      sortby='districtcost', vlist=[0,vmax])
MakeAllocationHeatMap(init_n_1400_BASE, optparamdict, plotTitle='B=1400, base setting', cmapstr=col,
                      sortby='districtcost', vlist=[0,vmax])
