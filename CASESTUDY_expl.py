...
#util_avg = np.load(os.path.join('casestudyoutputs', '31MAY', 'util_avg_expl.npy'))
#util_hi = np.load(os.path.join('casestudyoutputs', '31MAY', 'util_hi_expl.npy'))
#util_lo = np.load(os.path.join('casestudyoutputs', '31MAY', 'util_lo_expl.npy'))
