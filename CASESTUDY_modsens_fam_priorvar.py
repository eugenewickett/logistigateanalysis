...
TNvar, SNvar = 4., 4.  # Variances for use with prior; supply nodes are wide due to uncertainty
...
(0.5354797928473836, 0.5470037811809696), (0.5589589380962681, 0.570611204709724), 
]
'''
...
np.save(os.path.join('casestudyoutputs', 'modeling_sensitivity', 'fam_MS_priorvar_4_util_hi'), util_hi)
np.save(os.path.join('casestudyoutputs', 'modeling_sensitivity', 'fam_MS_priorvar_4_util_lo'), util_lo)
...
# Store
np.save(os.path.join('casestudyoutputs', 'modeling_sensitivity', 'fam_MS_priorvar_4_util_avg_unif_90'), util_avg_unif_90)
np.save(os.path.join('casestudyoutputs', 'modeling_sensitivity', 'fam_MS_priorvar_4_util_avg_rudi_90'), util_avg_rudi_90)
...
np.save(os.path.join('casestudyoutputs', 'modeling_sensitivity', 'fam_MS_priorvar_4_util_avg_unif_180'), util_avg_unif_180)
np.save(os.path.join('casestudyoutputs', 'modeling_sensitivity', 'fam_MS_priorvar_4_util_avg_rudi_180'), util_avg_rudi_180)
...
# Store results
np.save(os.path.join('casestudyoutputs', 'modeling_sensitivity', 'fam_MS_priorvar_1_alloc'), alloc)
np.save(os.path.join('casestudyoutputs', 'modeling_sensitivity', 'fam_MS_priorvar_1_util_avg'), util_avg)
np.save(os.path.join('casestudyoutputs', 'modeling_sensitivity', 'fam_MS_priorvar_1_util_hi'), util_hi)
np.save(os.path.join('casestudyoutputs', 'modeling_sensitivity', 'fam_MS_priorvar_1_util_lo'), util_lo)
...
# Store
np.save(os.path.join('casestudyoutputs', 'modeling_sensitivity', 'fam_MS_priorvar_1_util_avg_unif_90'), util_avg_unif_90)
np.save(os.path.join('casestudyoutputs', 'modeling_sensitivity', 'fam_MS_priorvar_1_util_avg_rudi_90'), util_avg_rudi_90)
...
np.save(os.path.join('casestudyoutputs', 'modeling_sensitivity', 'fam_MS_priorvar_1_util_avg_unif_180'), util_avg_unif_180)
np.save(os.path.join('casestudyoutputs', 'modeling_sensitivity', 'fam_MS_priorvar_1_util_avg_rudi_180'), util_avg_rudi_180)
